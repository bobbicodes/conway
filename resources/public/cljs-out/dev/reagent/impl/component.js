...
if((i < len)){
var k = (ks[i]);
var G__10028 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__10029 = (i + (1));
m = G__10028;
i = G__10029;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__10030 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__10030) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__10030));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__10032 = c;
var G__10032__$1 = (((G__10032 == null))?null:G__10032.prototype);
if((G__10032__$1 == null)){
return null;
} else {
return (G__10032__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__10034 = c;
var G__10034__$1 = (((G__10034 == null))?null:G__10034.prototype);
if((G__10034__$1 == null)){
return null;
} else {
return (G__10034__$1["render"]);
}
})() == null))));
});
...
var G__10036 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__10036) : reagent.impl.component.as_element.call(null,G__10036));
};
...
var _STAR_current_component_STAR_10042 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_10042;
}});
...
var G__10043 = key;
var G__10043__$1 = (((G__10043 instanceof cljs.core.Keyword))?G__10043.fqn:null);
switch (G__10043__$1) {
...
return ((function (G__10043,G__10043__$1){
...
var c = this;
var G__10048_10050 = (c["cljsRatom"]);
if((G__10048_10050 == null)){
} else {
reagent.ratom.dispose_BANG_(G__10048_10050);
}
...
var renders_10052 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_10053 = cljs.core.first(cljs.core.vals(renders_10052));
if((cljs.core.count(renders_10052) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_10052))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_10053)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_10053], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__10051 = name;
switch (G__10051) {
case "":
...
var G__10056 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__10056) : reagent.impl.component.global$module$create_react_class.call(null,G__10056));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__10057 = fiber;
var G__10057__$1 = (((G__10057 == null))?null:(G__10057["type"]));
if((G__10057__$1 == null)){
return null;
} else {
return (G__10057__$1["displayName"]);
}
})();
var parent = (function (){var G__10058 = fiber;
if((G__10058 == null)){
return null;
} else {
return (G__10058["return"]);
}
})();
var path = (function (){var G__10059 = parent;
var G__10059__$1 = (((G__10059 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__10059) : reagent.impl.component.fiber_component_path.call(null,G__10059)));
if((G__10059__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10059__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__10061 = c;
if((G__10061 == null)){
return null;
} else {
return (G__10061["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__10062._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__10064 = c;
if((G__10064 == null)){
return null;
} else {
return (G__10064["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__10066 = c;
if((G__10066 == null)){
return null;
} else {
return G__10066._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__10068 = instance;
if((G__10068 == null)){
return null;
} else {
return (G__10068["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__10069 = instance;
if((G__10069 == null)){
return null;
} else {
return G__10069._currentElement;
}
}
})();
var name = (function (){var G__10070 = elem;
...
var owner = (function (){var or__3949__auto__ = (function (){var G__10072 = elem;
if((G__10072 == null)){
return null;
} else {
return (G__10072["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__10073._owner;
}
}
})();
var path = (function (){var G__10074 = owner;
var G__10074__$1 = (((G__10074 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__10074) : reagent.impl.component.component_path.call(null,G__10074)));
if((G__10074__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10074__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__10075 = c;
var G__10075__$1 = (((G__10075 == null))?null:G__10075.constructor);
if((G__10075__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__10075__$1);
}
}
})();
