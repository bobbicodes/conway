...
cljs_test_display.notify.failure = (function cljs_test_display$notify$failure(p__10303){
...
var error = cljs.core.get.call(null,map__10304__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var fail = cljs.core.get.call(null,map__10304__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
return cljs_test_display.notify.with_permission.call(null,"granted",((function (map__10304,map__10304__$1,error,fail){
return (function (){
...
});})(map__10304,map__10304__$1,error,fail))
);
});
